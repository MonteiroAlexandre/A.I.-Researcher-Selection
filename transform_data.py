...
def transform(df):
    ...
    #Adiciona uma coluna categórica p fazer a classificaçao
    ...
    #Divide o conjunto de dados entre treino e teste para balancear o conjunto de treino
    ...
    #Over-sampling do dataset para equilibrar
